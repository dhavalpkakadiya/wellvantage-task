...
const LeadTable = () => {
  ...
  return (
    <div className="bg-white overflow-hidden border rounded-[6px]">
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="border-b h-[75px] border-[#F1F1F1] !bg-[#FFFDFD]">
            <tr>
              <th className="px-6 py-4 text-center text-sm font-bold text-[16px] text-[#333333]">
                Name
              </th>
              <th className="px-6 py-4 text-center text-sm font-bold text-[16px] text-[#333333]">
                Interest Level
              ...
              leads.map((lead) => (
                <tr key={lead._id || lead.id} className="hover:bg-gray-50 transition-colors bg-[#FFFFFF]">
                  <td className="px-6 py-2 text-center">
                    <div className="flex items-center lg:!pl-10 lg:gap-5">
                      <div className="w-10 h-10 rounded-full bg-[#BBBBBB] flex items-center justify-center flex-shrink-0">
                        <img
                          src={personIcon}
                          alt="person"
                          className="w-5 h-5"
                  ...
                  <td className="px-6 py-4 text-center">{lead.assignedTo || 'N/A'}</td>
                  ...
                  <td className="px-6 py-4 text-center box">
